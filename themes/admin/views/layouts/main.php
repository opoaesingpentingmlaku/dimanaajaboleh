...
<div id="header"> 
	...
	<?php $this->widget('frontend.extensions.emenu.EMenu',array(
			...
			'items'=>array(
					...
					array('label'=>'Factory', 'url'=>array('/advisor/factory'),
						
						),
					
					array('label'=>'Member', 'url'=>array('/admin/members/default')
						),	
					array('label'=>'Review', 'url'=>array('/admin/advisor/review/lists'),
						),	
